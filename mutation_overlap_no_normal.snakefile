...
rule overlap_all:
    input:
        expand("easy_transfer/overlap_no_normal/{tumor}_{f_score_thresh}_overlap_parsed.vcf", tumor = tumors, f_score_thresh = [0.8]),
...
rule compute_overlap:
    ...
    output:
        ...
        final_out_vcf = "easy_transfer/overlap_no_normal/{tumor}_{f_score_thresh}_overlap.vcf",
        final_out_parsed = "easy_transfer/overlap_no_normal/{tumor}_{f_score_thresh}_overlap_parsed.vcf",
